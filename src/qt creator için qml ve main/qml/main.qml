            ...
            Rectangle {
                ...
                Rectangle {
                    ...
                    Label {
                        id: labelTopInfo
                        color: "#5f6a82"
                        text: qsTr("ETU COMPUTER ENGINEER")
                        anchors.left: parent.left
                        anchors.right: parent.right
                        anchors.top: parent.top
                        anchors.bottom: parent.bottom
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        LeftMenuBtn {
                            ...
                            width: leftMenu.width
                            text: qsTr("Open")
                            btnIconSource: "../images/svg_images/surveys.svg"
                            onClicked: {
                                stackView.push(Qt.resolvedUrl("pages/sendSignal.qml"))
                        ...
                        LeftMenuBtn {
                            ...
                            width: leftMenu.width
                            text: qsTr("Open")
                            btnIconSource: "../images/svg_images/red-circle.svg"
                            onClicked: {
                                stackView.push(Qt.resolvedUrl("pages/video.qml"))
                    ...
                    LeftMenuBtn {
                        ...
                        btnIconSource: "../images/svg_images/Emotiv_logo.svg"
                        onClicked: {
                            btnHome.isActiveMenu = false
                            btnSettings.isActiveMenu = true
                            Qt.resolvedUrl("pages/form.ui")
